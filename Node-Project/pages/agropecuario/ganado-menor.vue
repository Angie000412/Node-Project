...
<template>
  ...
  >
    <template #top>
      <v-toolbar flat>
        <v-toolbar-title><v-icon>mdi-sheep</v-icon>Ganado Menor</v-toolbar-title>
...
export default {
  ...
  data(){
    ...
    potenciales: [
            {
              title: 'Disponible',
              to: '/Agropecuario/potencial/potencial_ganadomenors'
            },
            {
              title: 'Implementable',
              to: '/Agropecuario/uso_final/uso_final_ganadomenors'
            },
...
electricidadMax(){
  ...
  methods: {
    ...
    editItem(item) {
      this.editedIndex = this.ganadomenors.indexOf(item)
    ...
    deleteItemConfirm() {
      /* this.ganadomenors.splice(this.editedIndex, 1)
      this.closeDelete() */
      var id =this.editedItem.id
                axios.delete('http://localhost:1337/api/ganadomenors/'+id+'/')
                .then(response=>{
...
var config = {
  method: 'put',
  url: 'http://localhost:1337/api/ganadomenors/'+id+'/',
  headers: { 
...
var config = {
  method: 'post',
  url: 'http://localhost:1337/api/ganadomenors',
  headers: { 
    'Content-Type': 'application/json'
  },
  data : data
